            ...
            <div class="row text-center">
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <form>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label mt-3">Имя</label>
                ...
                <p class="d-inline-flex gap-1">
                    <a class="btn btn-primary col-4" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
                       aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</a>
                    <button class="btn btn-primary col-4" type="button" data-bs-toggle="collapse"
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="card card-body">
                                После кнопки "Купить" введите адрес
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="collapse multi-collapse" id="multiCollapseExample3">
                            <div class="card card-body">
                                30 дней после получения товара
                            </div>
                        </div>
                </div>
        </main>
